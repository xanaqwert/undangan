...
var x = setInterval(function() {
    ...
    document.getElementById("time").innerHTML = "<div class='hours block'>" + hours + "<br>Hours</div>" + "<div class='seconds block'>" + seconds + "<br>Seconds</div></div>";
...
console.log('%ccopyright: ©xanaqwert%c\n\nInstagram: @xanaqwerty', styles1, styles2);

console.log(
    `%cCukup cape ngerjain ni website jamet, selamat uda nemuin kata kata ini, sebenernya ini si easter egg aja\n\n`,
